    ...
    return (
        ...
        >
            ...
            >
                ...
                <p>Click <Link href='https://docs.google.com/document/d/1Xm6akvrmAn360wR8ZAZPJTt7jQ-Y8-P8YuEsWTNXOcI/edit?usp=sharing' target="_blank" className="text-blue-500 underline hover:text-blue-700">here</Link> to view the documentation for this case study.</p>
            </AccordionTab>
        </Accordion>
    )
}